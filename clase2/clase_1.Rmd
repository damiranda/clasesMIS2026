...
Entender diversas formas de usar evidencia en contextos de investigación para responder preguntas de interés en psicología.
...
|:------|:------------------|
|09.09	|Entrega 1 – Análisis de Artículo |
|28.09	|Prueba Integrativa 1|
|07.10	|Entrega 2 – Análisis de Artículo |
|11.11	|Entrega 3 – Análisis de Artículo |
|30.11	|Prueba Integrativa 2 |
...
knitr::include_graphics('./files/clases.png')
```
...
```{r echo=FALSE, out.width = '50%', fig.align='center'}
knitr::include_graphics('./files/eval.png')
```
...
Junto con lo señalado en el reglamento académico, obtener una nota final igual o superior a 4,0 (cuatro coma cero) en las actividades de evaluación propuesta para la asignatura.  
