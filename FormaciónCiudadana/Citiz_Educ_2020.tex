...
\title[Psicología UDD: Ciudadanía y Participación] % this is the reduced title for the foots
	...
	\framebreak
		\item Democracia crítica
			\begin{itemize}
				...
				\item Crítica y mejora de la igualdad a travez de la acción política y social
			\end{itemize}
...
\item Participación: Cambio (proliferación) de los repertorios de participación (Van deth, 2001)
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.5\linewidth]{Vandeth}
				%\caption{Van Deth, 2001}
			\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{participa}
		%\caption{IDEA, 2016}
	\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{toma}
		%\caption{IDEA, 2016}
	\end{figure}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth]{chile1}
		%\caption{IDEA, 2016}
	\end{figure}
   ...
   \begin{figure}
   	\centering
   	\includegraphics[width=0.8\linewidth]{trend_protest1}
   	%\caption{IDEA, 2016}
   \end{figure}
   ...
   \begin{figure}
   	\centering
   	\includegraphics[width=0.8\linewidth]{ciclo_}
   	%\caption{IDEA, 2016}
   \end{figure}
...
\begin{frame} [allowframebreaks]
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.5\linewidth]{mapdeth}
		%\caption{IDEA, 2016}
	\end{figure}
    ...
    \begin{figure}
    	\centering
    	\includegraphics[width=0.9\linewidth]{theocharis}
    	%\caption{IDEA, 2016}
    \end{figure}
   ...
   \begin{figure}
   	\centering
   	\includegraphics[width=0.9\linewidth]{tabla}
   	%\caption{IDEA, 2016}
   \end{figure}
...
\begin{frame} [allowframebreaks]
	\begin{itemize}
		\item IEA Civic Education Study, CIVED 1999. Australia, Belgium (French), Bulgaria, Canada, \textbf{Chile}, Colombia, Cyprus, Czech Republic, Denmark, England, Estonia, Finland, Germany, Greece, Hong Kong SAR, Hungary, Israel, Italy, Latvia, Lithuania, Netherlands, Norway, Poland, Portugal, Romania, Russian Federation, Slovak Republic, Slovenia, Sweden, Switzerland, and United States.
		
	\framebreak
		\item International Civic and Citizenship Education Study, ICCS 2009
		...
		\item Estudio de Educación Cívica 2017. Agencia de la Calidad de Educación. 
		
		\item Panel Chileno de Socialización Política, 2019-2021. 1500 jóvenes, familias y profesores.
...
\begin{frame}
			\begin{figure}
				\centering
				\includegraphics[width=0.4\linewidth]{tolerance_book}
				\label{fig:Vandeth}
				%\caption{Van Deth, 2001}
			\end{figure}
...
\begin{frame}
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{midevidencias}
		%\label{fig:Vandeth}
		%\caption{Van Deth, 2001}
	\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{march}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{paint}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{occupy}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{edu2}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{edu1}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{gini_marcha}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{gini_rayar}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{gini_trafic}
	%\caption{IDEA, 2016}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{gini_ocupa}
	%\caption{IDEA, 2016}
\end{figure}
